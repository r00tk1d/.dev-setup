...
cd tasks
chmod +x git-work-setup.sh ssh.sh core-setup.sh node-setup.sh zsh-setup.sh dotfiles.sh jira.sh java.sh productivity-tools.sh software.sh intellij-ultimate.sh brave-browser.sh spotify.sh
